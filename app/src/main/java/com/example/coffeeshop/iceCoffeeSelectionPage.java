...
public class iceCoffeeSelectionPage extends AppCompatActivity {
    ...
    double[] itemPrices = {99, 149, 199, 249, 299};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ice_coffee_selection_page);
    ...
    protected void onResume() {
        ...
        for (int i = 0; i < iconsId.length; i++) {
            ...
            isAddIcon[i] = orderManager.getIceCoffeeIconState()[i];
        ...
        for (int i = 0; i < iconsId.length; i++) {
            ...
            addIcon.setOnClickListener(view -> {
                ...
                if(isAddIcon[index]) {
                    ...
                    orderManager.iceCoffeeSetIconState(index, false);
                } else {
                    addIcon.setImageResource(R.drawable.baseline_add_24);
                    orderManager.decrementOrderCount();
                    orderManager.updateOrderTotal(-itemPrice);
                    orderManager.iceCoffeeSetIconState(index, true);
                }
                updateOrderCounter(orderManager.getOrderCount());
    ...
    public void goToCartPage() {
       orders.setOnClickListener(view -> {
           Intent goToOrderPage = new Intent(iceCoffeeSelectionPage.this, viewCart.class);
